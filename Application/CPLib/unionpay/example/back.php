...
require_once("Application/CPLib/unionpay/quickpay_service.php");
...
$param['orderAmount']           = $coin*100;        //交易金额
$param['orderNumber']           = $Card; //订单号，必须唯一(不能与原交易相同)
...
$param['frontEndUrl']           = "http://pay.canpoint.net/payment/recharge/front_notify";    //前台回调URL, 后台交易可为空
$param['backEndUrl']            = "http://pay.canpoint.net/payment/recharge/back_notify";    //后台回调URL
